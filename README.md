...
2. Configuration:
   - The mod comes with a `config/config.jsonc` file where you can enable or disable the mod, choose a hemisphere, force a season, or allow SPT seasonal events to override.
